...
export const useCategoriesStore = defineStore('categories', () => {
  const categories = ref([
    ...
    { id: 5, name: 'Most popular Personality', nominees: [{ name: 'Adewuyi Oyindamola (Prinxy Oyin)', currentVotes: 0 }, { name: 'Yusuf Moriamo Idowu (Makanaki)', currentVotes: 0 }], icon: '🌟' },
  ...
  const applyApprovedVotes = (approvedVotesArray) => {
